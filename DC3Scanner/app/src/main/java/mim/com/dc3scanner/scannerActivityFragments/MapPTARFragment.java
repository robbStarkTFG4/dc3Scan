...
import mim.com.dc3scanner.util.custom.MapView4PTAR;
...
public class MapPTARFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        canvas = new MapView4PTAR(this.getContext(), R.raw.ptar);
        ...
        final ImageView imageView = view.findViewById(R.id.imaview_map_ptar);
        ...
        Picasso.get().load(R.raw.ptar).fit().
                into(imageView);
        return view;
